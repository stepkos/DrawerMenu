...
public class SimsonFragment extends Fragment {

    final static String TAG = "Simson";
    View view;
    ...
    public View onCreateView(@NonNull  LayoutInflater inflater, @Nullable  ViewGroup container, @Nullable  Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.simpson_fragment, container, false);
        ...
        calculateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(rangeA.getText()) || !isNumeric(rangeA.getText().toString())) {
                    ...
                    Toast.makeText(getActivity(), "SimsonFragment"+" a="+a+" b="+b+" prcision="+p, Toast.LENGTH_LONG).show();
                    Log.v(TAG,"SimsonFragment"+" a="+a+" b="+b+" prcision="+p);
    ...
    static double integrate(double a, double b, double N) {
        double h = (b - a) / N;
